...
class _EditarPerfilScreenState extends State<EditarPerfilScreen> {
  ...
  Future<void> _cargarDatos() async {
    ...
    final perfil  = await context.read<PerfilViewModel>().perfil ??
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              _Subtitulo('Nivel educativo'),
              const SizedBox(height: 12),
              ..._nivelesEducativos.map((n) => _OpcionSeleccionable(
                label: n,
              ...
              _Subtitulo('Experiencia y habilidades'),
              const SizedBox(height: 12),
              VoiceInputField(
              ...
              _Subtitulo('Modalidad preferida'),
              const SizedBox(height: 12),
